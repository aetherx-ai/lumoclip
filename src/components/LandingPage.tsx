...
function SectionLabel({
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-violet-300/10 bg-violet-300/[0.045] px-3.5 py-1.5 shadow-[0_0_30px_rgba(139,92,246,0.035)]">
      ...
      <main id="top">
            ...
            <div className="mx-auto max-w-5xl text-center">
              ...
              <Reveal immediate delay={80}>
                ...
                >
                  ...
                  <span className="relative bg-gradient-to-r from-violet-100 via-violet-300 to-fuchsia-400 bg-clip-text text-transparent">
                    Shorts With AI.
                  </span>
                </h1>
              </Reveal>
        ...
        >
          ...
          <Reveal className="relative mx-auto max-w-4xl px-5 text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-[22px] border border-white/[0.08] bg-gradient-to-br from-violet-400/[0.08] to-fuchsia-500/[0.08]">
